#!/usr/bin/env node
// SEO Verification Script for claritybubble.com
// Run with: node verify-seo.js

const fs = require('fs');
const path = require('path');

console.log('🔍 SEO Setup Verification for claritybubble.com\n');
...
if (fs.existsSync(sitemapPath)) {
  ...
  requiredPages.forEach(page => {
    if (sitemap.includes(`https://claritybubble.com${page}`)) {
...
if (fs.existsSync(robotsPath)) {
  ...
  if (robots.includes('Sitemap: https://www.claritybubble.com/sitemap.xml')) {
...
console.log('Sitemap:');
console.log('  • https://www.claritybubble.com/sitemap.xml');
console.log('  • https://www.claritybubble.com/sitemap.xml');
console.log('  • https://www.claritybubble.com/sitemap (dynamic route)\n');
console.log('Robots:');
console.log('  • https://www.claritybubble.com/robots.txt');
console.log('  • https://www.claritybubble.com/robots.txt');
console.log('  • https://www.claritybubble.com/robots (dynamic route)\n');

console.log('📝 Google Search Console:');
console.log('  1. Add property: claritybubble.com');
